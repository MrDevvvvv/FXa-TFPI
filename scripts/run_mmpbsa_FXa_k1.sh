...
mpirun -np 24 --oversubscribe MMPBSA.py.MPI -O -i mmpbsa.in -o MMPBSA_FXa_k1.dat -eo FRAME_RESULTS_MMPBSA_FXa_k1.dat -sp stripped_FXa_k1.inp.prmtop -cp com.prmtop -rp rec.prmtop -lp lig.prmtop -y $location/stripped_FXa_k1_md.nc


# Clean up
mkdir mmpbsa_calculation
mv MMPBSA_FXa_k1.dat mmpbsa_calculation
mv FRAME_RESULTS_MMPBSA_FXa_k1.dat mmpbsa_calculation

# Copy data back to own folder
mv $magic/mmpbsa_calculation/* $location/mmpbsa_calculation/
rm -r $magic

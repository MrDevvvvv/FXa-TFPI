...
mpirun -np 24 --oversubscribe MMPBSA.py.MPI -O -i mmgbsa_per_residue_4_4_capped.in -o MMGBSA_per_res_FXa_k1.dat -do FRAME_RESULTS_MMGBSA_per_res_FXa_k1.dat -sp stripped_FXa_k1.inp.prmtop -cp com.prmtop -rp rec.prmtop -lp lig.prmtop -y $location/stripped_FXa_k1_md.nc


# Clean up
mkdir mmgbsa_calculation
mv MMGBSA_per_res_FXa_k1.dat mmgbsa_calculation
mv FRAME_RESULTS_MMGBSA_per_res_FXa_k1.dat mmgbsa_calculation

...
srun -n $SLURM_NTASKS MMPBSA.py.MPI -O -i mmpbsa.in -o MMPBSA.dat -eo FRAME_RESULTS_MMPBSA.dat -sp inp.prmtop -cp com.prmtop -rp rec.prmtop -lp lig.prmtop -y $location/md.nc

...
for t in replicate*; do
	...
	sed '0,/CYX 284/{/CYX 234/,/CYX 284/p}' FRAME_RESULTS_MMGBSA_per_res.dat -n > FRAME_RESULTS_MMGBSA_per_res_adj.dat
	python ~/data1/scripts/project_AlphaFold/analyse_per_res_capped_v2.py	
...
head -1 replicate_*/mmgbsa_calculation/mmgbsa_per_res.csv && grep ACE -A 200 replicate_*/mmgbsa_calculation/mmgbsa_per_res.csv
